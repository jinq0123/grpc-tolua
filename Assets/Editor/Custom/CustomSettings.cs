...
public static class CustomSettings
{
    ...
    {                
        ...
        // GrpcToLua
        // _GT(typeof(Grpc.Core.IAsyncStreamReader<byte[]>)),
        ...
        _GT(typeof(Grpc.Core.AsyncServerStreamingCall<byte[]>)),
        _GT(typeof(Grpc.Core.AsyncClientStreamingCall<byte[], byte[]>)),
        _GT(typeof(Grpc.Core.AsyncDuplexStreamingCall<byte[], byte[]>)),
