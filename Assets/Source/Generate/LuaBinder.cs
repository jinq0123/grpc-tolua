...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("Grpc");
		L.BeginModule("Core");
		Grpc_Core_ChannelWrap.Register(L);
		Grpc_Core_ChannelCredentialsWrap.Register(L);
		Grpc_Core_AsyncUnaryCall_LuaInterface_LuaTableWrap.Register(L);
		Grpc_Core_ChannelBaseWrap.Register(L);
		Grpc_Core_ClientBase_GrpcToLua_ClientWrap.Register(L);
		Grpc_Core_ClientBaseWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("GrpcToLua");
		GrpcToLua_InsecureCredentialsWrap.Register(L);
		GrpcToLua_ClientWrap.Register(L);
		GrpcToLua_ClientStreamingCallWrap.Register(L);
		GrpcToLua_ServerStreamingCallWrap.Register(L);
		GrpcToLua_DuplexStreamingCallWrap.Register(L);
		L.EndModule();
